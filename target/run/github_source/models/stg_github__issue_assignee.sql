  ...
  create or replace table `dbt-technical-training`.`dbt_aaron`.`stg_github__issue_assignee`
  ...
  as (
    ...
    select *
    from `dbt-technical-training`.`dbt_aaron`.`stg_github__issue_assignee_tmp`
